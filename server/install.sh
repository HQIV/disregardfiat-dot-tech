...
echo "API: $API_BASE"
echo ""
echo "1. Get an API key: open https://disregardfiat.tech/#arena and click \"Get API key\""
echo "   Or: curl -sS -X POST $API_BASE/keys -H 'Content-Type: application/json' -d '{\"label\":\"cli\"}'"
echo ""
echo "2. Install pyhqiv + hqiv-arena from GitHub:"
echo "   git clone --depth 1 https://github.com/disregardfiat/pyhqiv.git \"\$HOME/hqiv-workspace/pyhqiv\""
echo "   cd \"\$HOME/hqiv-workspace/pyhqiv\" && pip install -e \".[dev]\""
echo ""
echo "3. Login and run:"
echo "   export HQIV_ARENA_API_URL=\"$API_BASE\""
echo "   hqiv-arena login hqiv_YOUR_KEY_HERE"
